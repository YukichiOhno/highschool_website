...
# retrieve budget table information
def get_budget(connection):
    query = "SELECT * FROM BUDGET"
    budget_table = execute_read_query(connection, query)
    convert_values(budget_table)
    return jsonify(budget_table)